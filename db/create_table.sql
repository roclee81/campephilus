...
(
    ...
    `deviceSerialNumber0` varchar(32)  NOT NULL COMMENT '设备0序列号',
    `device_code1`        INT UNSIGNED NOT NULL COMMENT '设备1代码',
    `deviceSerialNumber1` varchar(32)  NOT NULL COMMENT '设备1序列号',
    `device_code2`        INT UNSIGNED NOT NULL COMMENT '设备2代码',
    `deviceSerialNumber2` varchar(32)  NOT NULL COMMENT '设备2序列号',
    `device_code3`        INT UNSIGNED NOT NULL COMMENT '设备3代码',
    `deviceSerialNumber3` varchar(32)  NOT NULL COMMENT '设备3序列号',
    `device_code4`        INT UNSIGNED NOT NULL COMMENT '设备4代码',
    `deviceSerialNumber4` varchar(32)  NOT NULL COMMENT '设备4序列号',
    `device_code5`        INT UNSIGNED NOT NULL COMMENT '设备5代码',
    `deviceSerialNumber5` varchar(32)  NOT NULL COMMENT '设备5序列号',
    PRIMARY KEY (pk_operation_number)
) COMMENT '手术使用的设备表';
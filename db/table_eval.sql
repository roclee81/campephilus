...
CREATE table `eval_cerebral_oxygen` (
    ...
    `control_panel-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '控制面板（包括电源开关、传感器插头等）',
    `control_panel-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `display_screen-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '显示屏（显示颜色、字体或图形大小、布局、尺寸大小等）',
    `display_screen-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `lead_wire-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '监测导联线与电极（连接是否方便、稳定）',
    `lead_wire-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `move_and_fix_device-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '移动与固定装置',
    `move_and_fix_device-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `backup_power_use_time-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '备用电源使用时间',
    `backup_power_use_time-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `monitor_parameter_set_and_value-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '监护参数指标设置与价值',
    `monitor_parameter_set_and_value-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `monitor_parameter_display_way-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '监护参数指标的展现形式（数字、图、表等）',
    `monitor_parameter_display_way-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `turn_on_self_test-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '开机启动及自检功能设置与时间',
    `turn_on_self_test-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `monitor_parameter_comprehensive-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '监测参数全面性（可监测的其他脑电参数种类是否齐全）',
    `monitor_parameter_comprehensive-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `data_store_function-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '数据存储功能',
    `data_store_function-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `data_export_function-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '数据导出功能',
    `data_export_function-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
...
CREATE table `eval_anesthesia_machine` (
    ...
    `display_screen-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `hand_control_device-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '手控装置、位置与操控',
    `hand_control_device-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `bellows_and_its_position-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '风箱及摆放位置',
    `bellows_and_its_position-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `soda_lime_tank_with_load_and_unload-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '钠石灰罐与装卸设置',
    `soda_lime_tank_with_load_and_unload-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `breath_loop_and_interface-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '呼吸回路接口',
    `breath_loop_and_interface-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `gas_flow_control_device-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '气体流量调节装置（氧气、空气）',
    `gas_flow_control_device-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `backup_power_use_time-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '备用电源使用时间',
    `backup_power_use_time-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `volatilize_tank_and_switch-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '挥发罐与开关、加药设置',
    `volatilize_tank_and_switch-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `flue_gas_let_out_device-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '废气排放装置',
    `flue_gas_let_out_device-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `move_and_fix_device-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '麻醉机移动与固定装置',
    `move_and_fix_device-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `operating_floor_size_and_position-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '麻醉机操作台大小、位置、使用方便等',
    `operating_floor_size_and_position-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `locker-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '储物柜',
    `locker-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `data_interface_type_and_function-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '数据接口类型、数量、功能',
    `data_interface_type_and_function-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `breath_pattern_type-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '呼吸模式种类',
    `breath_pattern_type-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `_e_t_c_o2_module-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '呼气末CO2浓度监测模块',
    `_e_t_c_o2_module-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `anesthetic_mol_monitor_module-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '吸入麻醉剂浓度监测模块',
    `anesthetic_mol_monitor_module-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `turn_on_self_test-design_reasonable`
...
CREATE table `eval_monitor` (
    ...
    `display_screen-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `pulse_oxygen_saturation_module-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '脉搏氧饱和度监测模块',
    `pulse_oxygen_saturation_module-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `_e_c_g_module-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '心电图监测模块',
    `_e_c_g_module-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `_n_i_b_p_cuff-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '无创血压袖带',
    `_n_i_b_p_cuff-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `_i_b_p_module-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '有创血压监测模块',
    `_i_b_p_module-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `_e_t_c_o2_module-design_reasonable`
    ...
    `backup_power_use_time-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `transport_function-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '转运功能（基于危重患者转运考虑的硬件设施配置）',
    `transport_function-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `monitor_parameter_layout-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '监护参数页面布局',
    `monitor_parameter_layout-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `monitor_parameter_adjust-design_reasonable`
    VARCHAR(64) NOT NULL COMMENT '监护参数调节（采集频率、数据形式等）',
    `monitor_parameter_adjust-operation_convenient`
    VARCHAR(64) NOT NULL COMMENT '',
    `monitor_parameter_comprehensive-design_reasonable`
    ...
    `parameter_accuracy_with_n_i_b_p`
    VARCHAR(64) NOT NULL COMMENT '监护参数：无创血压',
    `parameter_accuracy_with_i_b_p`
    ...
    `parameter_accuracy_with_e_t_c_o2`
    VARCHAR(64) NOT NULL COMMENT '监护参数：呼气末CO2',
    `parameter_accuracy_with_e_t_anesthetics_mol`
    ...
    `jamproof_capability_with_e_c_g`
    VARCHAR(64) NOT NULL COMMENT '心电监护抗干扰能力',
    `jamproof_capability_with_b_p`
    ...
    `monitor_b_p_with_satisfaction`
    VARCHAR(64) NOT NULL COMMENT '高血压、低血压识别准确率',
    `monitor_e_c_g_with_satisfaction`
    ...
    `monitor_e_t_c_o2_with_satisfaction`
...
CREATE table `eval_non_invasive_hemoglobin` (
    ...
    VARCHAR(64) NOT NULL COMMENT '',
    `parameter_accuracy_with_monitor_parameter`
    VARCHAR(64) NOT NULL COMMENT '1.[临床可靠性-参数准确性]监护参数：血红蛋白数值与实际血红蛋白、术中输血与失血量的相关性',
    `jamproof_capability_with_monitor`
    VARCHAR(64) NOT NULL COMMENT '2.[临床可靠性-抗干扰能力]监测抗干扰能力',
    `alert_device_in_time`
    VARCHAR(64) NOT NULL COMMENT '3.[临床可靠性-报警装置]即时与可靠性',
    `fault_rate_with_mainframe`
    VARCHAR(64) NOT NULL COMMENT '4.[临床可靠性-故障发生率]主机',
    `fault_rate_with_monitor_module`
    VARCHAR(64) NOT NULL COMMENT '5.[临床可靠性-故障发生率]监测模块',
    `fault_rate_with_lead_wire_and_sensor`
    VARCHAR(64) NOT NULL COMMENT '6.[临床可靠性-故障发生率]导联线与传感器',
    `identity_bleed_with_accuracy`
    VARCHAR(64) NOT NULL COMMENT '7.[临床可靠性-识别出血/失血的准确性和及时性]能否及时、准确的发现出血/失血状态',
    `blood_transfusion_with_accuracy`
    VARCHAR(64) NOT NULL COMMENT '8.[临床可靠性-输血指导准确性]输血、输液临床改善情况指导准确性',
    `advantage_compare_other_brand`
...
CREATE table `eval_maintenance_schedule` (
    ...
    `accessory_price`
    VARCHAR(64) NOT NULL COMMENT '费用-配件费',
    `maintain_price`
    VARCHAR(64) NOT NULL COMMENT '费用-维修费',
    `other_price`
    VARCHAR(64) NOT NULL COMMENT '费用-其他',
    `gmt_create`
    TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `gmt_modified`
    TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
...
CREATE table `eval_service_system_questionnaire_anesthesia_depth` (
    ...
    `jing_xiao_bi-device_work_year`
    VARCHAR(64) NOT NULL COMMENT '12.1仪器购入年限',
    `jing_xiao_bi-patient_num_every_year`
    VARCHAR(64) NOT NULL COMMENT '12.2平均每年使用仪器患者数量',
    `jing_xiao_bi-average_pay_every_patient`
    VARCHAR(64) NOT NULL COMMENT '12.3平均收费单价',
    `jing_xiao_bi-device_sale_price`
    VARCHAR(64) NOT NULL COMMENT '12.4仪器购入总价格',
    `jing_xiao_bi-total_pay_for_maintain_after_buy`
    VARCHAR(64) NOT NULL COMMENT '12.5仪器购入至今维护保养总费用',
    `economic_applicability-performance_rate`
    VARCHAR(64) NOT NULL COMMENT '仪器整体性价比',
    `economic_applicability-first_guarantee_period`
    VARCHAR(64) NOT NULL COMMENT '厂家提供的首次保修年限',
    `economic_applicability-renewal_method_and_price`
    VARCHAR(64) NOT NULL COMMENT '厂家提供的续保方式和价格',
    `economic_applicability-warranty_price`
    VARCHAR(64) NOT NULL COMMENT '厂家提供的保修价格',
    `economic_applicability-software_update_price`
    VARCHAR(64) NOT NULL COMMENT '厂家提供的软件升级价格',
    `train_service-description_practical`
    VARCHAR(64) NOT NULL COMMENT '仪器产品说明书实用性',
    `train_service-feedback_in_time`
    VARCHAR(64) NOT NULL COMMENT '厂家咨询反馈及时性',
    `train_service-remote_technical_support`
    VARCHAR(64) NOT NULL COMMENT '厂家远程技术支持',
    `train_service-clinical_application_training`
    VARCHAR(64) NOT NULL COMMENT '厂家提供的临床应用培训',
    `train_service-device_install_maintain_training`
    VARCHAR(64) NOT NULL COMMENT '厂家提供的仪器安装保养培训',
    `after_sale_service-response_time`
    VARCHAR(64) NOT NULL COMMENT '厂家售后响应时间',
    `after_sale_service-fault_exclude_time`
    VARCHAR(64) NOT NULL COMMENT '厂家维修故障排除时间',
    `after_sale_service-maintain_price`
    VARCHAR(64) NOT NULL COMMENT '需要的维修价格',
    `after_sale_service-producer_attitude`
    VARCHAR(64) NOT NULL COMMENT '厂家售后服务态度',
    `after_sale_service-complaint_handing_satisfaction`

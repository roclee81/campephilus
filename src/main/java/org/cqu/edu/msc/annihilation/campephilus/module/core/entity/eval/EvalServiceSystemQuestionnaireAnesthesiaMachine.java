...
@Entity
@Data
@Table(name = "eval_service_system_questionnaire_anesthesia_machine")
public class EvalServiceSystemQuestionnaireAnesthesiaMachine extends BaseEvalSuperclass implements Serializable {

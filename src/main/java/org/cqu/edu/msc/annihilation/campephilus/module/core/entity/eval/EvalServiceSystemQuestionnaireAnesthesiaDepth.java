...
@Entity
@Data
@Table(name = "eval_service_system_questionnaire_anesthesia_depth")
public class EvalServiceSystemQuestionnaireAnesthesiaDepth extends BaseEvalSuperclass implements Serializable {

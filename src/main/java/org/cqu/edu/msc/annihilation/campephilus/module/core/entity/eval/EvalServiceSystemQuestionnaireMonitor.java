...
@Entity
@Data
@Table(name = "eval_service_system_questionnaire_monitor")
public class EvalServiceSystemQuestionnaireMonitor extends BaseEvalSuperclass implements Serializable {

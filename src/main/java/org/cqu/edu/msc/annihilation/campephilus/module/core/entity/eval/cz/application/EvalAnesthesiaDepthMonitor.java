 ...
 */
@Data
@Entity(name = "anesthesiaDepthMonitorEvaluation")
@EntityListeners(AuditingEntityListener.class)
@Table(name = "eval_application_anesthesia_depth_monitor")
public class EvalAnesthesiaDepthMonitor implements Serializable {

...
import org.cqu.edu.msc.annihilation.campephilus.statistical.cache.StatisticalCache;
import org.cqu.edu.msc.annihilation.campephilus.statistical.cache.StatisticalRequestCache;
...
import org.cqu.edu.msc.annihilation.campephilus.core.dto.CurrentStatisticsRequestDTO;
import org.cqu.edu.msc.annihilation.campephilus.core.enums.CollectorStateEnum;
...
import org.cqu.edu.msc.annihilation.campephilus.core.service.ScheduledService;
import org.cqu.edu.msc.annihilation.campephilus.core.service.StatisticalService;
import org.cqu.edu.msc.annihilation.campephilus.core.utils.RemoveDuplicatesUtil;
...
//        //TODO 在多线程下，统计值会丢失
    ...
    private void updateStatisticalCache(StatisticalDO tempStatisticalDO) {
        ...
        // TODO statisticalCache.getOperationNumberList().get();
        statisticalCache.getHospitalCode().addAll(tempStatisticalDO.getHospitalCodeList());

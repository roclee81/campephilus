 ...
 */
@Repository
public interface EvalServiceSystemQuestionnaireNonInvasiveHemoglobinRepository extends JpaRepository<EvalServiceSystemQuestionnaireNonInvasiveHemoglobin, Integer> {
}

...
@Entity
@Data
@Table(name = "eval_service_system_questionnaire_breathing_machine")
public class EvalServiceSystemQuestionnaireBreathingMachine extends BaseEvalSuperclass implements Serializable {

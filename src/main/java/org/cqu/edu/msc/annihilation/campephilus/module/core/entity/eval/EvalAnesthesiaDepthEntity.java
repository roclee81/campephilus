...
public class EvalAnesthesiaDepthEntity extends BaseEvalSuperclass implements Serializable {
    ...
    public EvalAnesthesiaDepthEntity(String companyName, String deviceType, String otherDeviceType, String doctorName, String doctorCompany, String doctorDepartment, String doctorDuty, String doctorProfessionalTitle, String doctorWorkYear, String doctorFamiliarWithDevice, String controlPanelDesignReasonable, String controlPanelOperationConvenient, String displayScreenDesignReasonable, String displayScreenOperationConvenient, String leadWireDesignReasonable, String leadWireOperationConvenient, String moveAndFixDeviceDesignReasonable, String moveAndFixDeviceOperationConvenient, String backupPowerUseTimeDesignReasonable, String backupPowerUseTimeOperationConvenient, String monitorParameterSetAndValueDesignReasonable, String monitorParameterSetAndValueOperationConvenient, String monitorParameterDisplayWayDesignReasonable, String monitorParameterDisplayWayOperationConvenient, String turnOnSelfTestDesignReasonable, String turnOnSelfTestOperationConvenient, String monitorParameterComprehensiveDesignReasonable, String monitorParameterComprehensiveOperationConvenient, String dataStoreFunctionDesignReasonable, String dataStoreFunctionOperationConvenient, String dataExportFunctionDesignReasonable, String dataExportFunctionOperationConvenient, String parameterAccuracyWithAnesthesiaDepth, String parameterAccuracyWithComaDepth, String parameterAccuracyWithBrainDamage, String parameterAccuracyWithResponseTime, String jamproofCapabilityWithMonitor, String alertDeviceInTime, String faultRateWithMainframe, String faultRateWithMonitorModule, String faultRateWithLeadWireAndSensor, String anesthesiaInductionSatisfaction, String anesthesiaMaintainSatisfaction, String anesthesiaRecoverySatisfaction, String consciousJudgeSatisfaction, String brainDamageJudgeSatisfaction, String advantageCompareOtherBrand, String disadvantageCompareOtherBrand) {
        ...
        this.doctorProfessionalTitle = doctorProfessionalTitle;
        this.doctorWorkYear = doctorWorkYear;
        this.doctorFamiliarWithDevice = doctorFamiliarWithDevice;
        this.controlPanelDesignReasonable = controlPanelDesignReasonable;
        this.controlPanelOperationConvenient = controlPanelOperationConvenient;
        this.displayScreenDesignReasonable = displayScreenDesignReasonable;
        this.displayScreenOperationConvenient = displayScreenOperationConvenient;
        this.leadWireDesignReasonable = leadWireDesignReasonable;
        this.leadWireOperationConvenient = leadWireOperationConvenient;
        this.moveAndFixDeviceDesignReasonable = moveAndFixDeviceDesignReasonable;
        ...
        this.turnOnSelfTestDesignReasonable = turnOnSelfTestDesignReasonable;
        this.turnOnSelfTestOperationConvenient = turnOnSelfTestOperationConvenient;
        this.monitorParameterComprehensiveDesignReasonable = monitorParameterComprehensiveDesignReasonable;
        this.monitorParameterComprehensiveOperationConvenient = monitorParameterComprehensiveOperationConvenient;
        this.dataStoreFunctionDesignReasonable = dataStoreFunctionDesignReasonable;
        this.dataStoreFunctionOperationConvenient = dataStoreFunctionOperationConvenient;
        this.dataExportFunctionDesignReasonable = dataExportFunctionDesignReasonable;
        this.dataExportFunctionOperationConvenient = dataExportFunctionOperationConvenient;
        this.parameterAccuracyWithAnesthesiaDepth = parameterAccuracyWithAnesthesiaDepth;
        this.parameterAccuracyWithComaDepth = parameterAccuracyWithComaDepth;
        this.parameterAccuracyWithBrainDamage = parameterAccuracyWithBrainDamage;
        this.parameterAccuracyWithResponseTime = parameterAccuracyWithResponseTime;
        this.jamproofCapabilityWithMonitor = jamproofCapabilityWithMonitor;
        this.alertDeviceInTime = alertDeviceInTime;
        this.faultRateWithMainframe = faultRateWithMainframe;
        this.faultRateWithMonitorModule = faultRateWithMonitorModule;
        this.faultRateWithLeadWireAndSensor = faultRateWithLeadWireAndSensor;
        this.anesthesiaInductionSatisfaction = anesthesiaInductionSatisfaction;
        this.anesthesiaMaintainSatisfaction = anesthesiaMaintainSatisfaction;
        this.anesthesiaRecoverySatisfaction = anesthesiaRecoverySatisfaction;
        this.consciousJudgeSatisfaction = consciousJudgeSatisfaction;
        this.brainDamageJudgeSatisfaction = brainDamageJudgeSatisfaction;
        this.advantageCompareOtherBrand = advantageCompareOtherBrand;
        this.disadvantageCompareOtherBrand = disadvantageCompareOtherBrand;
    }
}

...
@Entity
@Data
@Table(name = "eval_service_system_questionnaire_non_invasive_hemoglobin")
public class EvalServiceSystemQuestionnaireNonInvasiveHemoglobin extends BaseEvalSuperclass implements Serializable {
